    ...
    <Container className='main-container' fluid>
      <Container className='options'>
        ...
        <Container className='artist-buttons' fluid>
          <Row>
            <Col>
              <Button variant='secondary' className='artist-btn'>
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-info-square" viewBox="0 0 16 16">
            ...
            <Col>
              <Button variant='secondary' className='artist-btn'>
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-vinyl-fill" viewBox="0 0 16 16">
            ...
            <Col>
              <div className='link-box'>
                <a href={`https://${website}`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" fill="currentColor" color='white' className="bi bi-at" viewBox="0 0 16 16">
            ...
            <Col>
              <div className='link-box'>
                <a href={`https://${facebook}`}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" color='white' className="bi bi-facebook" viewBox="0 0 16 16">
